# 3 настольной игре Скрабл (Scrabble) каждая буква имеет определенную ценность. В случае с
...
points_scrabs = {1: 'AEIOULNSTRАВЕИНОРСТ',
                 2: 'DGДКЛМПУ',
                 3: 'BCMPБГЁЬЯ',
                 4: 'FHVWYЙЫ',
                 5: 'KЖЗХЦЧ',
...
print("Slovo", text, "imeet ochkov v summe ravnoe", sum(
    [k for i in text for k, v in points_scrabs.items() if i in v]))
